...
def main():
    ...
    if checkpoint is None:
        decoder = DecoderWithSoftAttention(attention_dim=attention_dim,
                                       embed_dim=emb_dim,
        ...
        encoder.finetune(fine_tune_encoder)
    ...
    train_loader = torch.utils.data.DataLoader(
        COCODataset(data_folder, data_name, 'TRAIN', transform=transforms.Compose([normalize])),
